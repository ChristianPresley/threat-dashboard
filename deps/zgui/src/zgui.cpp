...
extern "C"
{
    ...
    */
    ...
    ZGUI_API const char *zguiSaveIniSettingsToMemory(size_t *out_size)
    {
        return ImGui::SaveIniSettingsToMemory(out_size);
    }

    ZGUI_API void zguiLoadIniSettingsFromMemory(const char *data, size_t size)
    {
        ImGui::LoadIniSettingsFromMemory(data, size);
    }

    ZGUI_API bool zguiIoGetWantSaveIniSettings(void)
    {
        return ImGui::GetIO().WantSaveIniSettings;
    }

    ZGUI_API void zguiIoClearWantSaveIniSettings(void)
    {
